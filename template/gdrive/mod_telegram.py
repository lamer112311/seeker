...
title = input(G + '[+]' + C + ' Название группы : ' + W)
desc = input(G + '[+]' + C + ' Описание группы : ' + W)
image = input(G + '[+]' + C + ' Путь к изображению (Лучший размер : 300x300) : ' + W)
mem_num = input(G + '[+]' + C + ' Кол-во участников : ' + W)
online_num = input(G + '[+]' + C + ' Кол-во участников Онлайн : ' + W)
