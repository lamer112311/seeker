function information()
{
  ...
  {
    brw = 'Недоступно'
    console.log('Browser Недоступно')
  }
  ...
  {
    ven = 'Недоступно';
    console.log('GPU Vendor Недоступно')
  }
  if (ren == undefined)
  {
    ren = 'Недоступно';
    console.log('GPU Renderer Недоступно')
  }
  console.log(ven);
  console.log(ren);
  //
